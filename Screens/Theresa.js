...
const TheresaScreen = ({ navigation }) => {
        ...
        <View style={styles.container}>
            <View style={styles.inContainer}>
                <View style={styles.hostelBox}>
                    ...
                    <Text style={styles.hostelName}>St Theresa’s Hotel</Text>
                ...
                <View style={styles.priceBox}>
                    ...
                    <Text style={styles.priceText}>One in a room        <Text style={styles.moneyText}>GHS 16,000.00</Text></Text>
                    
                    <Text style={styles.priceText}>Two in a room        <Text style={styles.moneyText}>GHS 16,000.00</Text></Text>
                    
                    <Text style={styles.priceText}>Three in a room      <Text style={styles.moneyText}>GHS 16,000.00</Text></Text>
                ...
                <View style={styles.contactBox}>
                    ...
                    <View style={styles.contactBox}> 
                        <View style={styles.call}>
                          ...
                          <Text style={styles.callText}>josephkorm1@gmail.com</Text>
                        </View>

                        <View style={styles.call}>
                          <Image source={require('../assets/email (2).png')} style={styles.logo}/>
                          <Text style={styles.callText}>0543316245/0507971597</Text>
                        </View>
                    </View>
                </View>
